...
type FormSubmitEvent = Parameters<
  NonNullable<React.JSX.IntrinsicElements["form"]["onSubmit"]>
>[0]
...
const EmailPass = () => {
  ...
  const handleSubmit = async (e: FormSubmitEvent) => {
    ...
    const { data, error } = await authClient.changePassword(
      {
        newPassword: formProps.newPassword as string, // required
        currentPassword: formProps.currentPassword as string, // required
